...
- 配重测试
  - 正确的配重：
    - BCD排空，从调节器呼吸，身体应漂浮在水面齐眼的高度，呼气时慢慢下沉。
    - 若背着满气的气瓶，额外增加2kg或5磅的重量。
    
- 清除呼吸管积水
  - 1.用力吹气，清除积水
  - 2.小心吸气，通过呼吸道控制避免吸入残留的水
  - 3.再次用力吹气，将所有积水排尽。
...
- 从不断漏气的调节器呼吸
  - 1.将咬嘴靠在嘴唇上，不要用嘴封住咬嘴，但可以放入咬嘴的一侧到口中。
  - 2.从涌出的空气中小口吸所需的空气，让多余的空气溢出。
  - 3.迅速开始以安全速率上升。
  
- 在水底口吹充气BCD
  - 1.左手握住BCD充气排气阀。
  - 2.从调节器吸一口气，将1/3-1/2吹入BCD。 -> 需保留注意清洁调节器积水的空气量。
  - 注意：当调节器不在口中时要吹气泡。

## 第十六课 理论

- 免停留潜水
  - 在免停留极限内，在潜水时，如果有必要，可以免停留直接回到水面。
  - 若超过免停留极限，必须做减压停留。
